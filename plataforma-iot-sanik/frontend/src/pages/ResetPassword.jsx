        ...
        {done ? (
            ...
            <div>
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full bg-[#F8FAFC] border rounded-xl pl-11 pr-12 py-3.5 text-sm outline-none transition-all duration-300 focus:bg-white focus:ring-4"
                  style={{ borderColor: confirm && confirm !== password ? '#F87171' : COLORS.border, color: COLORS.text, '--tw-ring-color': 'rgba(103, 183, 232, 0.2)' }}
                  onFocus={(e) => e.target.style.borderColor = COLORS.primary}
                  onBlur={(e) => e.target.style.borderColor = confirm && confirm !== password ? '#F87171' : COLORS.border}
                  required
                />
              </div>
          ...
          <div className="text-center py-6">
            <p className="text-sm mb-6" style={{ color: COLORS.textMuted }}>
              El enlace de recuperación es inválido o está incompleto. Pedí uno nuevo para continuar.
            </p>
            <Link
              to="/forgot-password"
              className="inline-block w-full text-center text-white font-bold py-3.5 rounded-xl transition-all duration-300"
              style={{ background: `linear-gradient(to right, #3bb4ffff , #80ceffff)`, boxShadow: '0 4px 14px rgba(103, 183, 232, 0.3)' }}
            >
